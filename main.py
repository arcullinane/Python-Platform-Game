...
class Game:
    ...
    def update(self):
        ...
        #check to see player hits platform only if falling
        ...
        if self.player.rect.top <= HEIGHT / 4:
            ...
            for cloud in self.clouds:
                cloud_speed = random.randrange(10, 21) / 10
    ...
    def show_start_screen(self):
         ...
         self.draw_text("Andrew Cullinane", 18, WHITE, WIDTH / 2, HEIGHT - 20)
         pg.display.flip()
         self.wait_for_key()
